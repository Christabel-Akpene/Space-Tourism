...
const Home = () => {
    return (
      <div className="text-white px-10 w-dvw overflow-hidden lg:grid lg:grid-rows-[100px_auto] lg:min-h-[calc(100dvh-173px)]">
        ...
        <div className="flex flex-col text-center items-center space-y-10 pt-5 sm:pt-16 lg:flex-row lg:text-left">
            <div className="flex flex-col items-center lg:justify-between lg:items-start lg:w-1/2 lg:pl-20">
                <p><span className="text-md inline-block pb-3 sm:text-3xl lg:text-lg">SO, YOU WANT TO TRAVEL TO</span> <br /> <span className="text-7xl lg:text-8xl font-bold inline-block pb-7">SPACE</span></p>
