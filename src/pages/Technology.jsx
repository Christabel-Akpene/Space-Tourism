...
const Technology = () => {
  ...
  return (
    <div className="text-white lg:ml-32 animate-slideIn">
      ...
      <div key={selected} className="flex flex-col lg:flex-row justify-between items-center space-x-10 pb-20 animate-slideUp">
